...
import (
	...
	"github.com/guijun/iris/core/maintenance"
	"github.com/guijun/iris/core/netutil"
	"github.com/guijun/iris/core/router"
	// handlerconv conversions
	"github.com/guijun/iris/core/handlerconv"
	// cache conversions
	"github.com/guijun/iris/cache"
	// view
	"github.com/guijun/iris/view"
	// middleware used in Default method

	requestLogger "github.com/guijun/iris/middleware/logger"
...
//
// Example: https://github.com/guijun/iris/tree/master/_examples/subdomains/redirect
...
var (
	...
	//
	//
	// Examples: https://github.com/guijun/iris/tree/master/_examples/file-server
	...
	//
	// Examples can be found at: https://github.com/guijun/iris/tree/master/_examples/#caching
	Cache = cache.Handler
	...
	// Use this, which is a shortcut of the, `chache#Cache304` instead of the "github.com/guijun/iris/cache" or iris.Cache
...
//
// Example: https://github.com/guijun/iris/tree/master/_examples/file-server/single-page-application
...
// https://github.com/guijun/iris/blob/master/_examples/http-listening/notify-on-shutdown/main.go
