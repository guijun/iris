...
[View or download sample code](https://github.com/guijun/iris/tree/master/_examples/websocket).
...
* import the `"github.com/guijun/iris/websocket"`
...
```go
import "github.com/guijun/iris/websocket"
```
